...
export function DetailsInput({field, placeholder, Icon, type}:DetailInputType) {
  ...
  return (
    <div className={`p-2 rounded-md w-full border flex items-center gap-2 md:gap-5 bg-white ${!Array.isArray(formData[field]) && formData[field].error ? 'border-red-500' : 'border-gray-300'}`}>
           <Icon color='gray'/>
