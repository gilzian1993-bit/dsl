 ...
 captionLayout = "label",
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background group/calendar p-3 rounded-md shadow-sm [--cell-size:2rem]",
        className
      )}
      ...
      classNames={{
        ...
        nav: cn(
          "flex items-center gap-1 w-full absolute top-0 inset-x-0 justify-between px-3",
          defaultClassNames.nav
        ),
        button_previous: cn(
          buttonVariants({ variant: buttonVariant }),
          "w-8 h-8 p-0 text-white hover:bg-teal-700 rounded-full",
        ...
        month_caption: cn(
          "flex items-center justify-center h-10 w-full px-2 rounded-md bg-teal-600 text-white font-semibold",
        ...
        dropdown_root: cn(
          "relative border border-input shadow-xs ring-ring/50 ring-[3px] rounded-md focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:border-green-500",
        ...
        weekdays: cn("flex px-3", defaultClassNames.weekdays),
        weekday: cn(
          "text-gray-500 text-sm font-medium w-8 h-8 flex items-center justify-center",
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "data-[range-start=true]:rounded-md data-[range-start=true]:rounded-l-md [&>span]:text-xs [&>span]:opacity-70",
        defaultClassNames.day,
        className
      )}
      {...props}
